...
from src.model.layers import MLPLayers, activation_layer
...
class xDeepFM(ContextRecommender):
    ...
    def __init__(self, args, field_names, field_sources, field2type, field2num):
        super(xDeepFM, self).__init__(args, field_names, field_sources, field2type, field2num)
        ...
        self.cin_layer_size = temp_cin_size = args.cin_layer_size
    ...
    def calculate_loss(self, interaction):
        ...
        return output, self.loss(output, label) + self.reg_weight * l2_reg
